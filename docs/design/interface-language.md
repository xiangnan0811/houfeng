...
Use `docs/development/ui-preview-and-browser-sanity.md` for user-visible frontend work. It defines:
...
Repository Playwright and Chromium verification are established workflows. Use the maintained development guide and quality policy; adding another browser framework or CI visual regression system needs a separate technical decision.
