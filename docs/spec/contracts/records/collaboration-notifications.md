...
deletion orchestrator。相关集成 只发布 typed facts/provider/adapter，不创建
...
与 aggregate readiness 由 [集成与恢复合同](integration-recovery.md) 约束；已有生产 gate 接线不代表所有删除 readiness 条件已满足。
