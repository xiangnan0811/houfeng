...
type MonitoringInstanceBindingConflictSectionProps = {
...
export function MonitoringInstanceBindingConflictSection({
  bindingConflict,
  loading,
  error,
  bindingAction,
  ...
  onReject,
  onReset,
}: MonitoringInstanceBindingConflictSectionProps) {
