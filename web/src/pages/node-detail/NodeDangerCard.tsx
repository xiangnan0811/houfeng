...
import type { ActiveIncidentRecord, NodeRecord } from '../../lib/types'

type NodeDangerCardProps = {
  node: NodeRecord
  firstIncident: ActiveIncidentRecord | null
  onOpenEvents: () => void
}

export function NodeDangerCard({ node, firstIncident, onOpenEvents }: NodeDangerCardProps) {
  return (
