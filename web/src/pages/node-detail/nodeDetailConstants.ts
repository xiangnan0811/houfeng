import type { HistoryTab, NodeCommand, TimeWindow } from './types'

export const NODE_BINDING_CONFLICT_LOAD_ERROR = '绑定冲突详情暂不可用'
export const NODE_BINDING_ACTION_ERROR = '更新绑定冲突状态失败'
export const NODE_LIFECYCLE_ACTION_ERROR = '节点生命周期操作失败'
export const NODE_BINDING_CONFLICT_STATUS = '指纹变更待确认'
export const NODE_BINDING_CONFIRM_REBIND_LABEL = '确认重绑定'
export const NODE_BINDING_REJECT_PENDING_LABEL = '拒绝新指纹'
export const NODE_BINDING_RESET_LABEL = '重置绑定'
export const NODE_LIFECYCLE_RETIRED = '已退役'
export const NODE_LIFECYCLE_V1_LIMITATION_COPY =
  '已退役节点在 V1 中只能先恢复到观察中，不能直接恢复为在用。'

export const COMMAND_LIST: NodeCommand[] = [
