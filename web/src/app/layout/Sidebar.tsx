    ...
    <aside className="sidebar">
      ...
      <nav>
        ...
        <div className="nav-section">
          ...
          <SidebarNavItem to="/nodes" label="节点" badge={anomalyCounts.nodes} icon={<svg viewBox="0 0 16 16"><circle cx="8" cy="8" r="3"/><path d="M8 2v2M8 12v2M2 8h2M12 8h2"/></svg>} />
          <SidebarNavItem to="/targets" label="入口" badge={anomalyCounts.targets} icon={<svg viewBox="0 0 16 16"><path d="M2 8h3l2-4 2 8 2-4h3"/></svg>} />
