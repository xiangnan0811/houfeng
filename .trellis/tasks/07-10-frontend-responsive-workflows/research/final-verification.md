...
- 已提交实现截至 `30a99dbd755bcffbfea9e14d8c43561b04a9b190`；该 commit 包含扩展三主题 axe 后发现的 Asset light-theme context contrast RED/GREEN 修复。
...
| Provider ArrowRight | focus region 后 `scrollLeft: 0 → 3` | 键盘滚动通过 |
