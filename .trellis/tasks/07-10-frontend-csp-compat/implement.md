...
- Final repository gates: Node `22.23.1` 下 `NODE_ENV=production make verify-web` 与 `make verify` 均通过（86 test files、632 tests、lint、strict TS build、全部 Go fmt/vet/test）；`npm audit --include=dev` 为 0 vulnerabilities。
